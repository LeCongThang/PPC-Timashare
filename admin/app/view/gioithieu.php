                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade active in" role="tabpanel" id="vi"
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <textarea name="noidung_vi" class="ckeditor" id="noidung_en" cols="30" rows="10" title=""><?php echo $gioithieu_vi['noidung_gioithieu']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /. box -->
                                    <div class="tab-pane fade" role="tabpanel" id="en" aria-labelledby="en-tab">
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                <textarea name="noidung_en" class="ckeditor" id="noidung_en" cols="30" rows="10" title=""><?php echo $gioithieu_en['noidung_gioithieu']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
