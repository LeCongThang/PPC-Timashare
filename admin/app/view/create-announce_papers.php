...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1><b>
                    <?php echo $isUpdate ? 'Cập nhật tin thông báo' : 'Thêm tin thông báo'; ?>
                </b>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input placeholder="Đường dẫn" class="form-control"
                                           value="<?php echo $isUpdate ? $data_vi['link'] : "" ?>"
                                           name="link"
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade active in" role="tabpanel" id="vi"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea placeholder="Mô tả" name="noidung_vi" class="ckeditor" cols="30"
                                                           rows="10"
                                        ...
                                        <div class="tab-pane fade" role="tabpanel" id="en"
                                            ...
                                            <div class="form-group">
                                                <label for="noidung">Nội dung</label>
                                                <textarea placeholder="Mô tả" name="noidung_en" class="ckeditor" cols="30"
                                                          rows="10"
