                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="thumbnail input-group col-sm-12" style="text-align: center">
                                        <img id="img"
                                             src="<?php echo BASE_DIR . 'img/default_avatar.png' ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group" style="text-align: center">
                                        <label
                                            class="radio-inline"><input checked type="radio" value="0" name="status">Còn
                                            hiệu lực</label>
                                        <label
                                            class="radio-inline"><input type="radio" value="1" name="status">Giới
                                            hạn</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group" style="text-align: center">
                                        ...
                                        <label
                                            class="radio-inline"><input checked type="radio" value="1" name="id_vaitro">User</label>
                                    </div>
                                </div>
