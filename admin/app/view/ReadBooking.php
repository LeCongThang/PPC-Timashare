                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-sm-4">
                                                <label class="checkbox-inline"><input type="radio" value="0"
                                                                                      name="status" <?php echo $data['s'] == 0 ? "checked" : "" ?> >  Chưa
                                                    duyệt</label>
                                            </div>
                                            <div class="col-md-4 col-sm-4">
                                                <label class="checkbox-inline"><input type="radio" value="1"
                                                                                      name="status" <?php echo $data['s'] == 1 ? "checked" : "" ?> >  Thành
                                                    công</label>
                                            </div>
                                            <div class="col-md-4 col-sm-4">
                                                <label class="checkbox-inline"><input type="radio" value="-1"
                                                                                      name="status" <?php echo $data['s'] == -1 ? "checked" : "" ?> >  Hủy
                                                    bỏ</label>
                                            </div>
                                        </div>
                                    </div>
