...
(function ($) {
    $.fn.zPaging = function (options) {
        ...
        var defaults = {
            ...
            "currentPage": 1,
            "total": 0,
            "btnPrevious": ".goPrevious_connect",
            "btnNext": ".goNext_connect",
            "txtCurrentPage": "#currentPage_connect",
            "pageInfo": ".pageInfo_connect"
        };
        ...
        function init() {
            ...
            //Lay tong so trang
            $.ajax({
                url: lang + "/controller/getNumberConnect",
                type: "GET",
                dataType: "json"
            }).done(function (data) {
        ...
        function loadData(page) {
            ...
            $.ajax({
                url: lang + "/controller/getListConnect",
                type: "POST",
                dataType: "json",
                cache: false,
                data: {
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function (i, val) {
                        var str = '<div class="col-md-6 col-sm-12 caption_deals"><img class="img-responsive" src="' + base_dir + val.image + '"><h3><a  href="' + base_dir + lang + '/controller/getDetailConnect/' + val.id + '">' + val.title + '</a></h3><h5 class="content_">' + val.date + '</h5></div>';
                        rows.append(str);
                    });
                    ...
                    var bottom_content = '<div class="pages col-md-12"><p >' + page_name + temp + '</p></div>';
