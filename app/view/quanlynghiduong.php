                            ...
                            <div class="polaroid">
                                ...
                                <b>
                                    <div class="form-group">
                                        <p>ĐỊA CHỈ </p>
                                        <input type="text" name="noidung1" style="width:98%;height:40px;"
                                               value="<?php echo $row['thongtin']; ?>">
                                        <br><br>
                                        <p>THÔNG TIN</p>
                                        <textarea rows="10" cols="98%;"
                                                  style="width:98%;border:1px solid grey; border-radius:2px;"
                                                  name="noidung2"><?php echo trim($row['diachi']); ?></textarea>
                                        <br><br>
                                        <p>SỐ ĐIỆN THOẠI </p>
                                        <input type="text" name="noidung3" style="width:98%;height:40px;"
