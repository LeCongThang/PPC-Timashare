                    ...
                    <table class="table">
                        ...
                        <div class="row text-center">
                            ...
                            foreach ($ds_tai_khoan as $key => $item_taikhoan) {
                                ...
                                <tr>
                                    <form
                                        action="<?= BASE_URL.$_SESSION['lang'] ?>/controllertaikhoan/layThongTinUser/<?php echo $item_taikhoan['tendangnhap']; ?>"
                                        method="POST">
                                    ...
                                    <td>
                                        <a href="<?= BASE_URL ?>controllertaikhoan/delete/<?php echo $item_taikhoan['tendangnhap']; ?>"
