        ...
        <section class="content" style="height:1000px;">
            ...
            <div class="col-md-12 col-sm-12 text-center">
                ...
                <div class="row text-center" style="<?php echo $bg; ?>">
                    <div class="col-md-2">
                        <h4><?php echo $row['id_khunghi']; ?></h4>
                    </div>
                    <div class="col-md-4">
                        <h4><?php echo $row['diachi']; ?></h4>
                    </div>
                    <div class="col-md-4">
                        <h4><?php echo $row['sdt']; ?></h4>
                    </div>
                    <div class="col-md-2" style="padding-top:2px;">
                       <a href="<?=BASE_URL?>controllertrangthai/chitiet/<?php echo $row['id_khunghi']; ?>"> <button class="btn btn-info" ><i class="glyphicon glyphicon-th"></i></button></a>
                    </div>
                </div>
                <?php $i++; } ?>
            </div>
