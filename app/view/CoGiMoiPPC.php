...
<script type="text/javascript" src="<?= BASE_DIR ?>js/paging_resort_new.js"></script>
<div class="container">
    <div class="row text-left">
        <div class="col-md-12 col-sm-12">
            ...
            <h2 class="title_h2">{CoGiMoiTai} PPC TIMESHARE</h2>
        </div>
    </div>

    <div class="row">
        <div id="paging_new" style="margin-bottom: 40px">
            <div id="row_new"></div>
        </div>
    </div>
