                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border text-center">
                                <?php if (isset($data['image'])): ?>
                                    <img src="<?= BASE_DIR . $data['image'] ?>" style="width:70%;">
                                <?php endif; ?>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <input placeholder="Tiêu đề" class="form-control" value="<?php echo $data['title'] ; ?>" name="title"
                                           style="font-size:17px;font-family:verdana;text-align:justify;">
                                </div>
                                <div class="form-group">
                                    <label for="noidung">Nội dung</label>
                                    <textarea placeholder="Nội dung" name="content" id="editor1" cols="30" rows="10" title="">
                            ...
                            <div class="box-footer">
                                <div class="pull-right">
                                    ...
                                    <button type="submit" name="submit" class="btn btn-info"><i
                                            class="glyphicon glyphicon-th-large"></i>&nbsp <b><?php echo $isUpdate ? "Cập nhật":"Thêm"?></b></button>
                                </div>
