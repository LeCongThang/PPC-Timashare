                                    ...
                                    foreach ($ds_mail as $key => $item_mail) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><a
                                                    href="<?= BASE_URL.$_SESSION['lang'] ?>/controllermail/xemmail/<?php echo $item_mail['email_lienhe']; ?> "><?php echo $item_mail['ten_lienhe']; ?></a>
                                            </td>
                                            ...
                                            <td class="mailbox-date"><a
                                                    href="<?= BASE_URL . $_SESSION['lang'] ?>/controllermail/delete/<?php echo $item_mail['email_lienhe']; ?> ">
