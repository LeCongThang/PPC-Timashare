                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border text-center">
                                <div class="pull-left">
                                   <!-- <a href="<?/*= BASE_URL */?>controllerbook/create" class="btn btn-success"><i
                                            class="glyphicon glyphicon-th-large"></i>&nbsp <b>Thêm book</b></a>-->
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <?php foreach ($books as $key => $book): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= BASE_DIR ?>controllerbook/update/<?= $book['id'] ?>" class="btn btn-primary">Sửa</a>
                                                <a href="<?= BASE_DIR ?>controllerbook/delete/<?= $book['id'] ?>" class="btn btn-danger">Xóa</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
